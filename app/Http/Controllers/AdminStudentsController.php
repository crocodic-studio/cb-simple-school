<?php namespace App\Http\Controllers;
	...
	class AdminStudentsController extends \crocodicstudio\crudbooster\controllers\CBController {
		...
		$this->col[] = array("label"=>"Age","name"=>"age" );
		...
		$this->form[] = ["label"=>"Gender","name"=>"gender","type"=>"select","required"=>TRUE,"validation"=>"required|min:1|max:255","dataenum"=>"Male;Female"];
	    ...
	    */    
	    public function hook_row_index($column_index,&$column_value) {	        
	    	//Your code here
	    	if($column_index=='4'){
	    		if($column_value=='Female'){
	    			$column_value = "<label style='padding:5px;font-size:12px' class='label label-success'>Female</label>";
	    		}else{
	    			$column_value = "<label style='padding:5px;font-size:12px' class='label label-primary'>Male</label>";
	    		}
	    	}
	    }
